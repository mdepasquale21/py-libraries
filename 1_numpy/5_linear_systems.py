...
print('\n')
print('BUT THERE IS A MUCH BETTER WAY TO SOLVE THIS SYSTEM!')
print('Computing the inverse of a matrix is very slow and poorly accurate!')
print('There are much better algorithms to actually solve linear systems')
print('Like np.linalg.solve(A,b)')
fast_x = np.linalg.solve(coeff, b)
print('fast solution:', fast_x)
print('check with fast solution:', np.allclose(coeff@fast_x, b))
print('This method is faster and more accurate!')
print('So do not calculate the inverse of A and multiply it by b, use np.linalg.solve(A,b) instead!!!!!')
print('For this small problem there is almost no difference, but important differences can be seen for bigger and real problems!')
